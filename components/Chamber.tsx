  ...
  return (
    <section id="chamber" className="bg-gray-100 py-12 dark:bg-gray-800">
      <div className="mx-auto px-6">
        <h2 className="mb-8 text-center text-3xl font-bold text-gray-900 dark:text-gray-100">Chamber Information</h2>
        ...
        <div className="mt-8">
          <h3 className="mb-4 text-center text-2xl font-bold text-gray-900 dark:text-gray-100">Find Us on Map</h3>
