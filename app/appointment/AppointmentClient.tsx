    ...
    <div className="py-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="mb-6 text-center text-2xl font-bold text-gray-700 md:text-3xl dark:text-gray-300">
          Book Appointment — Hepatologist in Mirpur Dhaka
        </h2>
        <p className="mx-auto mb-8 max-w-3xl text-center text-lg text-gray-600 dark:text-gray-400">
          অধ্যাপক ডাক্তার মুহম্মদ মাহবুব হোসেন — মিরপুর ঢাকার সেরা হেপাটোলজিস্ট। সিরিয়ালের জন্য
          পপুলার ডায়াগনস্টিক সেন্টার, মিরপুরে যোগাযোগ করুন।
          <br />
          <span className="mt-1 block text-base">
            Prof. Dr. Muhammad Mahbub Hussain — Best Hepatologist in Mirpur, Dhaka. Contact Popular
            Diagnostic Centre, Mirpur to book an appointment.
          </span>
        </p>
